...
\begin{document}
   ...
   \end{adjustwidth}
    ...
    {\small
    \begin{tabular}{llllll}
    \begin{tabular}{l}\  \\\textbf{Languages}\end{tabular}&{\footnotesize  \begin{tabular}{lll}$\bullet$$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$\\Java&Python&C++\end{tabular}}
        & \begin{tabular}{l}\ \\\textbf{Platforms}\end{tabular}&{\footnotesize \begin{tabular}{ll}$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$\\Amazon AWS&Google Cloud\end{tabular}}
        &\begin{tabular}{l}\ \\\textbf{OS}\end{tabular}&{\footnotesize   \begin{tabular}{ll}$\bullet$$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$$\bullet$$\bullet$\\Linux&Windows\end{tabular}}\\
        \begin{tabular}{l}\ \\\textbf{Tools}\end{tabular}&{\footnotesize   \begin{tabular}{ll}$\bullet$$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$$\bullet$$\bullet$\\Git&Vim\end{tabular}}
        &\begin{tabular}{l}\ \\\textbf{Libraries}\end{tabular}&{\footnotesize
\begin{tabular}{lll}$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$&$\bullet$$\bullet$$\bullet$\\OpenCV&STL&J Collections\end{tabular}}
        &\begin{tabular}{l}\ \\\textbf{Frameworks}\end{tabular}&{\footnotesize  \begin{tabular}{ll}$\bullet$$\bullet$&$\bullet$$\bullet$\\Hadoop&MapReduce\end{tabular}}\\
    \begin{tabular}{l}\ \\\textbf{Office Suite}\end{tabular}&{\footnotesize \begin{tabular}{ll}$\bullet$$\bullet$$\bullet$$\bullet$&$\bullet$$\bullet$$\bullet$$\bullet$\\\LaTeX&MS Office\end{tabular}}\\
    \end{tabular}
    }
    %\end{comment}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
